...
@objc public enum DisplayLanguageType: Int {
    case chinese
    case english
    case spanish
    case fanti
 ...
 open class CountrySelectView: UIView {
    ...
    @objc
    public static let jsonCountrys = CountryCodeJson;
...
//            searchBarView.tintColor = _barTintColor
    ...
    var _displayLanguage : DisplayLanguageType = .chinese
...
extension tableViewDataSource : UITableViewDataSource{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if _displayLanguage == .fanti {
            countryCell.countryNameLabel.text = (searchCountrys[indexPath.row]["fanti"] as! String)
        }
