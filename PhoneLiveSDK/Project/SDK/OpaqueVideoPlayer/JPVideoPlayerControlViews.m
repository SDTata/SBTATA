...
- (void)_setup {
    ...
    self.dragSlider = ({
        ...
        [view setThumbImage:[ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_progress_handler_normal"]] forState:UIControlStateNormal];
        [view setThumbImage:[ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_progress_handler_hightlight"]] forState:UIControlStateHighlighted];
...
- (void)_setup {
    ...
    self.playButton = ({
        ...
        [button setImage:[ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_pause"]] forState:UIControlStateNormal];
        [button setImage:[ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_play"]] forState:UIControlStateSelected];
    ...
    self.landscapeButton = ({
        UIButton *button = [UIButton new];
        [button setImage:[ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_landscape"]] forState:UIControlStateNormal];
        [button setImage:[ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_portrait"]] forState:UIControlStateSelected];
...
- (void)_setup {
    ...
    self.blurImageView = ({
        ...
        if(!blurImage){
            blurImage = [ImageBundle imagewithBundleName:[bundlePath stringByAppendingPathComponent:@"jp_videoplayer_blur"]];
        }
