...
- (instancetype)initWithConfig:(SDWebImageDownloaderConfig *)config {
    ...
    if (self) {
        ...
        if (@available(iOS 13.0, *)) {
            sessionConfiguration.TLSMinimumSupportedProtocolVersion = tls_protocol_version_TLSv10;
            sessionConfiguration.TLSMaximumSupportedProtocolVersion = tls_protocol_version_TLSv13;
        } else {
        ...
        // 保存更新后的配置
        _config.sessionConfiguration = sessionConfiguration;
        /**
