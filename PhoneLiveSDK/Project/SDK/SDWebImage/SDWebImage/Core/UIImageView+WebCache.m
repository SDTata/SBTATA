...
- (void)sd_setImageWithURL:(nullable NSURL *)url {
    [self sd_setImageWithURL:url placeholderImage:[ImageBundle imagewithBundleName:@"image_placehold"] options:0 progress:nil completed:nil];
}
...
- (void)sd_setImageWithURL:(nullable NSURL *)url completed:(nullable SDExternalCompletionBlock)completedBlock {
    [self sd_setImageWithURL:url placeholderImage:[ImageBundle imagewithBundleName:@"image_placehold"] options:0 progress:nil completed:completedBlock];
}
