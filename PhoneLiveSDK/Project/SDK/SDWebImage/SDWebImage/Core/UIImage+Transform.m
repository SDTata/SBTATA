...
- (nullable UIImage *)sd_imageByRoundCornerRadius:(CGFloat)cornerRadius
{
    return [self sd_roundedCornerImageWithRadius:cornerRadius corners:UIRectCornerAllCorners borderWidth:0 borderColor:[UIColor clearColor]];
}
