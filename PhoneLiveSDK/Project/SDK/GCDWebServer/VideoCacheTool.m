...
@property (nonatomic, strong) NSString *lasFileNames;
@end
...
- (NSString *)getUrlStringWithRealUrlString:(NSString *)realUrlString {
    NSArray *filesStrArr = [realUrlString componentsSeparatedByString:@"/"];
    _lasFileNames = filesStrArr.lastObject;
    
    self.videoRealUrlString = [realUrlString stringByReplacingOccurrencesOfString:[NSString stringWithFormat:@"%@",_lasFileNames] withString:@""];
    
    NSString *urlStr = [NSString stringWithFormat:@"%@",self.videoLocalUrlString];
    
    urlStr = [NSString stringWithFormat:@"%@%@?realUrlStr=%@", urlStr, _lasFileNames, realUrlString];
...
- (NSString *)getReturnValueContenTypeWithPartName:(NSString *)partName {
    ...
    NSString *contenTypeString = [partName isEqualToString:_lasFileNames] ? @"application/x-mpegURL" : @"video/MP2T";
