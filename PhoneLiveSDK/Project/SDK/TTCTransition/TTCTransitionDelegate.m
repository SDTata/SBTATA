...
- (nullable id <UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if(operation == UINavigationControllerOperationPush) {
        ...
        presentOrPushAniTrans.bigCurPlayCell = self.bigCurPlayCell;
        ...
        dismissOrPopAniTrans.bigCurPlayCell = self.bigCurPlayCell;
...
- (void)setBigCurPlayCell:(UIView *)bigCurPlayCell {
    _bigCurPlayCell.alpha = 1;
    if(_bigCurPlayCell) {
        _bigCurPlayCell.alpha = 0.0;
    }
    [bigCurPlayCell layoutIfNeeded];
    _bigCurPlayCell = bigCurPlayCell;
    self.presentOrPushAniTrans.bigCurPlayCell = bigCurPlayCell;
    self.dismissOrPopAniTrans.bigCurPlayCell = bigCurPlayCell;
}

- (void)prepareGestureRecognizerInView:(UIView*)view {
    if (self.closeGestureDisable) {
        return;
    }
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    ...
    if ([otherGestureRecognizer.view isKindOfClass:GKDYVideoSlider.class]) {
        return NO;
    }
    return YES;
}
