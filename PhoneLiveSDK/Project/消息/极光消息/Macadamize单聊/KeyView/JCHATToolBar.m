...
- (void)switchToVoiceInputMode {
  ...
  [self.voiceButton setImage:[ImageBundle imagewithBundleName:@"chat_keyboard"] forState:UIControlStateNormal];
  [self.voiceButton setImage:[ImageBundle imagewithBundleName:@"chat_keyboard"] forState:UIControlStateHighlighted];
...
- (void)switchToolbarToTextMode {
  ...
  [self.voiceButton setImage:[ImageBundle imagewithBundleName:@"chat_voice"] forState:UIControlStateNormal];
  [self.voiceButton setImage:[ImageBundle imagewithBundleName:@"chat_voice"] forState:UIControlStateHighlighted];
