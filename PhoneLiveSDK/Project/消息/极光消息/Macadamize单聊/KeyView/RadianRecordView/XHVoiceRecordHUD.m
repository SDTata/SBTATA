...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
  ...
  self.recordingHUDImageView.image = [ImageBundle imagewithBundleName:imageName];
}
...
- (void)setup {
  ...
  if (!_microPhoneImageView) {
    ...
    microPhoneImageView.image = [ImageBundle imagewithBundleName:@"RecordingBkg"];
  ...
  if (!_recordingHUDImageView) {
    ...
    recordHUDImageView.image = [ImageBundle imagewithBundleName:@"RecordingSignal"];
  ...
  if (!_cancelRecordImageView) {
    ...
    cancelRecordImageView.image = [ImageBundle imagewithBundleName:@"RecordCancel"];
