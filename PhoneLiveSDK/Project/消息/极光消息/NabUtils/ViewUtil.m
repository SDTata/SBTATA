...
+ (UIView *)nib:(char *)nib {
  NSArray *nibs=[[XBundle currentXibBundleWithResourceName:NSStringFromClass(self)] loadNibNamed:[NSString stringWithUTF8String:nib]
                                              owner:self
                                            options:nil];
...
+ (void)table:(UITableView *)table registerNib:(char *)nib {
  [table registerNib:[UINib nibWithNibName:[NSString stringWithUTF8String:nib] bundle:[XBundle currentXibBundleWithResourceName:NSStringFromClass([self class])]] forCellReuseIdentifier:[NSString stringWithUTF8String:nib]];
}
