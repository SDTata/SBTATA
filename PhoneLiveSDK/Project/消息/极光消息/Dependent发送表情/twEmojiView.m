...
- (void)creatUI{
    ...
    [collectionView registerNib:[UINib nibWithNibName:@"emojiCell" bundle:[XBundle currentXibBundleWithResourceName:@"emojiCell"]] forCellWithReuseIdentifier:@"emojiCELL"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (indexPath.item >= emojiArray.count) {
        ...
        emojiCell *cell = (emojiCell *)[collectionView dequeueReusableCellWithReuseIdentifier:identifierCell
                                                                               forIndexPath:indexPath];
        cell.emojiImgView.image = [ImageBundle imagewithBundleName:emojiArray[indexPath.row]];
        return cell;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    if ([minstr(emojiArray[indexPath.row]) isEqualToString:@"345"]) {
        return;
    }
