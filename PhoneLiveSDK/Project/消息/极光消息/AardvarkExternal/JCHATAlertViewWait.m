...
- (void)showInView {
  ...
  [self.alertView mas_makeConstraints:^(MASConstraintMaker *make) {
    make.right.mas_equalTo([UIApplication sharedApplication].delegate.window);
    make.top.mas_equalTo([UIApplication sharedApplication].delegate.window).with.offset(0);
    make.left.mas_equalTo([UIApplication sharedApplication].delegate.window);
    make.bottom.mas_equalTo([UIApplication sharedApplication].delegate.window);
  }];
  ...
  clockImage.image = [ImageBundle imagewithBundleName:@"pub_wait"];
