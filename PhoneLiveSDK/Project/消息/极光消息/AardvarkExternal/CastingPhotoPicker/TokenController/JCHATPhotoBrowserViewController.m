...
- (void)setupCollectionView {
  ...
  [collectionView registerNib:[UINib nibWithNibName:@"JCHATPhotoBrowserCollectionViewCell" bundle:[XBundle currentXibBundleWithResourceName:NSStringFromClass([self class])]]
...
- (void)hidenAllBar {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        strongSelf->topBar.hidden = !strongSelf->topBar.hidden;
        strongSelf->bottomBar.hidden = !strongSelf->bottomBar.hidden;
    }];
}
