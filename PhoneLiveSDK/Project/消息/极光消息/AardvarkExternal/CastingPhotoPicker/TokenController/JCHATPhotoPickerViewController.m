...
- (void)viewDidLoad {
  ...
  self.navigationController.navigationBar.translucent = NO;
    _albumVC = [[JCHATAlbumViewController alloc] initWithNibName:@"JCHATAlbumViewController" bundle:[XBundle currentXibBundleWithResourceName:NSStringFromClass([self class])]];
