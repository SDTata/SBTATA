...
- (void)viewDidLoad {
    ...
    self.title = [NSString stringWithFormat:@"%@%@",self.currentToy.name, YZMsg(@"ToyDetailVC_toy_control")];
...
{
    [self.tableHeaderView setBatteryContent:[NSString stringWithFormat:@"%@:%i%%", YZMsg(@"ToyDetailVC_battery"),self.currentToy.battery]];
}
...
-(void)initAll
{
    ...
    UIBarButtonItem *rightBarItem = [[UIBarButtonItem alloc] initWithTitle:YZMsg(@"ToyDetailVC_disconnect") style:UIBarButtonItemStylePlain target:self action:@selector(onBreakClick)];
    ...
    if(self.currentToy.isConnected == true)
    {
        ...
        if(self.currentToy.toyType)
            [self.tableHeaderView setTypeContent:[NSString stringWithFormat:@"%@:%@", YZMsg(@"ToyDetailVC_device_type"),self.currentToy.toyType]];
        if(self.currentToy.version)
            [self.tableHeaderView setVersionContent:[NSString stringWithFormat:@"%@:%@", YZMsg(@"ToyDetailVC_version"),self.currentToy.version]];
    }
    else
    {
        //Connect a toy
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    {
        case 0:
            label.text = YZMsg(@"ToyDetailVC_all_toy_command");
            break;
        case 1:
            label.text = @"Nora";
            break;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.sliderName = YZMsg(@"ToyDetailVC_vibration");
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_quick_flash")];
    ...
    {
        [cell setSliderName:YZMsg(@"ToyDetailVC_preset") andMinValue:0 andMaxValue:10];
        [cell setSliderChangeBlock:^(int value) {
            NSMutableDictionary * paramDict = [NSMutableDictionary dictionary];
    ...
    {
        cell.sliderName = YZMsg(@"ToyDetailVC_nora_rotation");
        [cell setSliderChangeBlock:^(int value) {
            NSMutableDictionary * paramDict = [NSMutableDictionary dictionary];
    ...
    {
        cell.sliderName = YZMsg(@"ToyDetailVC_nora_rotation_anti_clockwise");
        [cell setSliderChangeBlock:^(int value) {
            NSMutableDictionary * paramDict = [NSMutableDictionary dictionary];
            [paramDict setObject:@(value) forKey:kSendCommandParamKey_RotateLevel];
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_nora_rotation_change")];
        [cell setBtnClickBlock:^{
    ...
    {
        cell.sliderName = [NSString stringWithFormat:@"Edge %@ 1", YZMsg(@"ToyDetailVC_vibration")];
        [cell setSliderChangeBlock:^(int value) {
            NSMutableDictionary * paramDict = [NSMutableDictionary dictionary];
            [paramDict setObject:@(value) forKey:kSendCommandParamKey_VibrateLevel];
    ...
    {
        cell.sliderName = [NSString stringWithFormat:@"Edge %@ 2", YZMsg(@"ToyDetailVC_vibration")];
        [cell setSliderChangeBlock:^(int value) {
            NSMutableDictionary * paramDict = [NSMutableDictionary dictionary];
            [paramDict setObject:@(value) forKey:kSendCommandParamKey_VibrateLevel];
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_turn_off_AID_light")];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_turn_on_AID_light")];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setBtnName:[NSString stringWithFormat:@"%@=%i", YZMsg(@"ToyDetailVC_get_AID_light_status"),self.isAidLightOn]];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_turn_off_light")];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_turn_on_light")];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_start_tracking_movement")];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setBtnName:YZMsg(@"ToyDetailVC_stop_tracking_movement")];
        [cell setBtnClickBlock:^{
    ...
    {
        [cell setSliderName:YZMsg(@"ToyDetailVC_max_air_in") andMinValue:1 andMaxValue:3];
        [cell setSliderChangeBlock:^(int value) {
            NSMutableDictionary * paramDict = [NSMutableDictionary dictionary];
    ...
    {
        [cell setSliderName:YZMsg(@"ToyDetailVC_max_air_out") andMinValue:1 andMaxValue:3];
    ...
    {
        [cell setSliderName:YZMsg(@"ToyDetailVC_max_air_auto") andMinValue:0 andMaxValue:3];
...
-(void)connectFailCallback:(NSNotification *)noti
{
    ...
    NSLog(@"%@",resonDict);
    UIAlertController *alertVc = [UIAlertController alertControllerWithTitle:nil message:[NSString stringWithFormat:@"%@=%@", YZMsg(@"SearchToyVC_connect_fail"),resonDict.description] preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *cancelBtn = [UIAlertAction actionWithTitle:YZMsg(@"publictool_sure") style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
    }];
...
-(void)deviceTypeCallback:(NSNotification *)noti
{
    ...
    {
        [self.tableHeaderView setMacContent:[NSString stringWithFormat:@"MAC Address:%@",self.currentToy.macAddress]];
        [self.tableHeaderView setTypeContent:[NSString stringWithFormat:@"%@:%@", YZMsg(@"ToyDetailVC_device_info"),self.currentToy.toyType]];
        [self.tableHeaderView setVersionContent:[NSString stringWithFormat:@"%@:%@", YZMsg(@"ToyDetailVC_version"),self.currentToy.version]];
    }
}
...
-(void)listenMove:(NSNotification *)noti
{
    ...
    [self.tableHeaderView setMoveLevel:[NSString stringWithFormat:@"%@:%@", YZMsg(@"ToyDetailVC_movement"),level]];
}
