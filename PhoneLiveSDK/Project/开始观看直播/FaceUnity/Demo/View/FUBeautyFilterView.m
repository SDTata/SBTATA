...
- (instancetype)initWithFrame:(CGRect)frame {
    FUBeautyFilterViewModel *viewModel = [FUBeautyFilterViewModel loadCacheForKey:@"FUBeautyFilterViewModel"];
    if (!viewModel) {
        viewModel = [[FUBeautyFilterViewModel alloc] init];
    }
...
- (void)saveBeautyModel {
    [FUBeautyFilterViewModel saveCache:self.viewModel forKey:@"FUBeautyFilterViewModel"];
}
