...
- (instancetype)initWithFrame:(CGRect)frame {
    FUBeautySkinViewModel *viewModel = [FUBeautySkinViewModel loadCacheForKey:@"FUBeautySkinViewModel"];
    if (!viewModel) {
        viewModel = [[FUBeautySkinViewModel alloc] init];
    }
...
- (void)saveBeautyModel {
    [FUBeautySkinViewModel saveCache:self.viewModel forKey:@"FUBeautySkinViewModel"];
}
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = FUMsg(skin.name);
