...
- (instancetype)initWithFrame:(CGRect)frame {
    FUMakeupViewModel *viewModel = [FUMakeupViewModel loadCacheForKey:@"FUMakeupViewModel"];
    if (!viewModel) {
        viewModel = [[FUMakeupViewModel alloc] init];
    }
...
- (void)saveBeautyModel {
    [FUMakeupViewModel saveCache:self.viewModel forKey:@"FUMakeupViewModel"];
}
