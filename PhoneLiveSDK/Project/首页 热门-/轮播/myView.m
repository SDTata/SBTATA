...
- (void)initView{
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"lunbocell" bundle:[XBundle currentXibBundleWithResourceName:NSStringFromClass([self class])]] forCellWithReuseIdentifier:YYIDCell];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.imageviewsss sd_setImageWithURL:[NSURL URLWithString:[self.newses[indexPath.row] valueForKey:@"slide_pic"]] placeholderImage:nil];
