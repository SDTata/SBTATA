...
- (void)creatUI{
    ...
    for (int i = 0; i < classArray.count; i++) {
        ...
        button.tag = i + 3000;
//        [button sd_setImageWithURL:[NSURL URLWithString:minstr([classArray[i] valueForKey:@"thumb"])] forState:0 placeholderImage:[ImageBundle imagewithBundleName:@"live_all"]];
...
//        button.imageView.contentMode = UIViewContentModeScaleAspectFit;
        ...
        [imgView sd_setImageWithURL:[NSURL URLWithString:minstr([classArray[i] valueForKey:@"thumb"])] placeholderImage:[ImageBundle imagewithBundleName:@"live_all"]];
...
- (void)showWhiteView{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        strongSelf->whiteView.frame = CGRectMake(0, 0, _window_width, strongSelf->count*_window_width/6+20);
        ...
        strongSelf->hidBtn.userInteractionEnabled = YES;
...
- (void)hideSelf{
    ...
    [UIView animateWithDuration:0.3 animations:^{
       ...
       strongSelf-> whiteView.frame = CGRectMake(0, -strongSelf->count*_window_width/6, _window_width, strongSelf->count*_window_width/6+20);
    } completion:^(BOOL finished) {
        STRONGSELF
        if (strongSelf == nil) {
            return;
