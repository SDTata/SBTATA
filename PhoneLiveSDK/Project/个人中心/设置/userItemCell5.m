...
+(userItemCell5 *)cellWithTableView:(UITableView *)tableView{
    ...
    if (!cell) {
        cell = [[XBundle currentXibBundleWithResourceName:@"userItemCell5"]loadNibNamed:@"userItemCell5" owner:self options:nil].lastObject;
    }
    cell.logOutLabel.text = YZMsg(@"setView_logout");
    return cell;
