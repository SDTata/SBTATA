...
-(void)navtion{
    ...
    self.titleLab.text = YZMsg(@"sexCell_Sexy");
...
- (void)viewDidLoad {
    ...
    if ([minstr(user.sex) isEqualToString:@"1"]) {
        [self.manBTN setImage:[ImageBundle imagewithBundleName:@"choice_sex_nanren"] forState:UIControlStateNormal];
        [self.womanBTN setImage:[ImageBundle imagewithBundleName:@"choice_sex_un_femal"] forState:UIControlStateNormal];
    }
    else{
        [self.womanBTN setImage:[ImageBundle imagewithBundleName:@"choice_sex_nvren"] forState:UIControlStateNormal];
        [self.manBTN setImage:[ImageBundle imagewithBundleName:@"choice_sex_un_male"] forState:UIControlStateNormal];
    }
    [self navtion];
