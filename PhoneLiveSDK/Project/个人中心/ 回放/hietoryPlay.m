...
- (void)viewDidLoad {
    ...
    [newPlaybtn setBackgroundImage:[ImageBundle imagewithBundleName:@"play"] forState:UIControlStateNormal];
    ...
    [returnBtns setImage:[ImageBundle imagewithBundleName:@"live_guest_close"] forState:UIControlStateNormal];
...
-(void)onPlayVideo{
    if (playokokokokook == 0) {
        [newPlaybtn setBackgroundImage:[ImageBundle imagewithBundleName:@"pause.png"] forState:UIControlStateNormal];
        [self.player play];
        playokokokokook = 1;
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
           STRONGSELF
            ...
            strongSelf->newPlaybtn.hidden = YES;
        });
