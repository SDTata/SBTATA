...
- (instancetype)initWithFrame:(CGRect)frame {
	...
	if (self = [super initWithFrame:frame]) {
		...
		self.playBtn = ({
			...
			[playBtn setBackgroundImage:[ImageBundle imagewithBundleName:@"play.png"] forState:UIControlStateNormal];
			[playBtn setBackgroundImage:[ImageBundle imagewithBundleName:@"pause.png"] forState:UIControlStateSelected];
		...
		self.sliderView = ({
			...
			[slider setThumbImage:[ImageBundle imagewithBundleName:@"slider"] forState:UIControlStateNormal];
		...
		self.chooseBtn = ({
			...
			[btn setImage:[ImageBundle imagewithBundleName:@"fullscreen"] forState:UIControlStateNormal];
		...
		self.closeBtn = ({
			...
			[closeBtn setImage:[ImageBundle imagewithBundleName:@"backbtn"] forState:UIControlStateNormal];
		...
		self.shearBtn = ({
			...
			[share setImage:[ImageBundle imagewithBundleName:@"share_normal"] forState:UIControlStateNormal];
			[share setImage:[ImageBundle imagewithBundleName:@"share_selected"] forState:UIControlStateHighlighted];
		...
		self.downBtn = ({
			...
			[down setImage:[ImageBundle imagewithBundleName:@"down_normal"] forState:UIControlStateNormal];
			[down setImage:[ImageBundle imagewithBundleName:@"down_selected"] forState:UIControlStateSelected];
		...
		self.slidBtn = ({
			...
			//			[slidBtn setImage:[ImageBundle imagewithBundleName:@"tab_poster_nav_n"] forState:UIControlStateNormal];
...
- (void)openSlidView:(void(^)(void))action {
	...
	if (self.isShow == NO) {
		[UIView animateWithDuration:0.5 animations:^{
			...
			strongSelf.collectionView.frame = CGRectMake(0, HEAD_H, strongSelf.bounds.size.width, COLL_H);
		...
		[UIView animateWithDuration:0.5 animations:^{
			...
			strongSelf.collectionView.frame = CGRectMake(0, COLL_Y, strongSelf.bounds.size.width, COLL_H);
		} completion:^(BOOL finished) {
            STRONGSELF
            if (strongSelf == nil) {
                return;
...
- (void)addControlBtn {
	...
	for (int i = 1; i <= CONT_BTN; i++) {
		...
		[btn setImage:[ImageBundle imagewithBundleName:@"slider_tip"] forState:UIControlStateNormal];
