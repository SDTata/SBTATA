...
+(LiveNodeTableViewCell *)cellWithTV:(UITableView *)tv{
    ...
    if (!cell) {
        cell = [[XBundle currentXibBundleWithResourceName:@"showNote"]loadNibNamed:@"showNote" owner:self options:nil].lastObject;
        cell.kanguoL.text = YZMsg(@"LiveNodeTableViewCell_peopleNumberTitle");
    }
    return cell;
}
@end
