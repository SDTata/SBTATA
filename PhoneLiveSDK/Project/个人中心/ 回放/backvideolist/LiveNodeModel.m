...
-(instancetype)initWithDic:(NSDictionary *)dic{
    self = [super init];
    if (self) {
        if([dic valueForKey:@"title"] == nil || [[dic valueForKey:@"title"] isEqual:[NSNull null]] || [minstr([dic valueForKey:@"title"]) isEqualToString:@""])
        {
            self.title = YZMsg(@"CommonPageVC_notitle");
        }
        else
        {
