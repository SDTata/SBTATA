...
NSString *const  getaddrss = @"getaddrss";
...
+(void) updateProfile:(liveCity *)city
{
        ...
        if(city.addr!=nil) [userDefaults setObject:city.addr forKey:getaddrss];
...
+ (void)saveProfile:(liveCity *)user
{
    ...
    [userDefaults setObject:user.addr forKey:getaddrss];
    [userDefaults synchronize];
}
+ (void)clearProfile{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    ...
    [userDefaults setObject:nil forKey:mylat];
    [userDefaults setObject:nil forKey:getaddrss];
    [userDefaults synchronize];
}
+ (liveCity *)myProfile{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    ...
    user.addr = [userDefaults objectForKey:getaddrss];
    return user;
}
+(NSString *)getMyCity{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
...
+(NSString *)getaddrss{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSString* lat = [userDefaults objectForKey: getaddrss];
    return lat;    
}
