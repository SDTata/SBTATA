...
@interface BaseFloatView : UIView
/**
 是不是能拖曳，默认为YES
 YES，能拖曳
 NO，不能拖曳
...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(BaseFloatView *dragView);
/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(BaseFloatView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(BaseFloatView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(BaseFloatView *dragView);
