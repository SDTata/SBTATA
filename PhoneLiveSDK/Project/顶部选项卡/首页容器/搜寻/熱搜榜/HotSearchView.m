...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *text = [NSString stringWithFormat:@"%@", dic[@"key"]];
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[HotSearchCollectionViewCell class] forCellWithReuseIdentifier:@"HotSearchCollectionViewCell"];
