...
- (void)configureTabButtonPropertys
{
    ...
    _normalTextColor = [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];//[UIColor colorWithRed:0.584 green:0.588 blue:0.592 alpha:1.00];
    
    _selectedTextColor = [UIColor blackColor];//[UIColor blackColor];
    _selectedbackcolor = [UIColor whiteColor];//[UIColor blackColor];
    
    _normalbackcolor = [UIColor whiteColor];//[UIColor colorWithRed:0.584 green:0.588 blue:0.592 alpha:1.00];
    
    _pagerBarColor = [UIColor whiteColor];//[UIColor whiteColor];
    _collectionViewBarColor = [UIColor whiteColor];//[UIColor colorWithRed:217/255.0 green:83/255.0 blue:126/255.0 alpha:1];//[UIColor whiteColor];
...
- (void)setBarStyle:(TYPagerBarStyle)barStyle
{
    ...
    if (barStyle == TYPagerBarStyleCoverView) {
        ...
        self.progressColor = RGB(184,92,238);
    }
