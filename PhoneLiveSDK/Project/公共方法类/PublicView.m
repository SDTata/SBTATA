...
+(void)indictorShow {
    ...
    PublicView *pubV = [[[XBundle currentXibBundleWithResourceName:@"PublicView"]loadNibNamed:@"PublicView" owner:nil options:nil]objectAtIndex:0];
...
+(void)showImgNoData:(UIView *)superView name:(NSString *)imgName text:(NSString *)text{
     ...
     *  公用类尺寸谨慎修改
     */
    PublicView *_noData = [[[XBundle currentXibBundleWithResourceName:@"PublicView"]loadNibNamed:@"PublicView" owner:nil options:nil]objectAtIndex:1];
    _noData.frame = CGRectMake(0, 0, superView.width, superView.height);
    _noData.noDataIV.image = [ImageBundle imagewithBundleName:imgName];
...
+(void)showTextNoData:(UIView *)superView text1:(NSString *)str1 text2:(NSString *)str2 {
     ...
     *  公用类尺寸谨慎修改
     */
    PublicView *_noData = [[[XBundle currentXibBundleWithResourceName:@"PublicView"]loadNibNamed:@"PublicView" owner:nil options:nil]objectAtIndex:2];
    _noData.frame = CGRectMake(0, 0, superView.width, superView.height);
...
+(void)showCommenting:(UIView *)superView {
    ...
    PublicView *_comment = [[[XBundle currentXibBundleWithResourceName:@"PublicView"]loadNibNamed:@"PublicView" owner:nil options:nil]objectAtIndex:3];
...
////    UIImage *gifImg = [UIImage sd_imageWithGIFData:@"center_gif"];
