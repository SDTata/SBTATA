...
#define secondarySystemBackgroundColor [UIColor whiteColor]
#define systemBackgroundColor [UIColor whiteColor]
...
- (UIColor *)titleBarColor {
    if (!_titleBarColor) {
        if (@available(iOS 13.0, *)) {
            _titleBarColor = [self br_customDynamicColor:[UIColor whiteColor] darkColor:secondarySystemBackgroundColor];
        } else {
...
- (UIColor *)pickerColor {
    if (!_pickerColor) {
        if (@available(iOS 13.0, *)) {
            _pickerColor = [self br_customDynamicColor:[UIColor whiteColor] darkColor:secondarySystemBackgroundColor];
        } else {
