...
- (instancetype)initWithDic:(NSDictionary *)dic {
    ...
    if (self) {
        ...
        _totalCoinStr = [NSString stringWithFormat:@"%.1f",[[dic objectForKey:@"totalcoin"] doubleValue]];
        ...
        NSString *att = [dic objectForKey:@"isAttention"];
        _isAttention = [NSString stringWithFormat:@"%@",att];
        _sex = YBValue(dic, @"sex");
        _region_icon = YBValue(dic, @"region_icon");
        _isLive = [[dic objectForKey:@"isLive"] boolValue];
