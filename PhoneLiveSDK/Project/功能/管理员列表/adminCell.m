...
-(void)setModel:(fansModel *)model{
    ...
    //级别
//    self.levelL.image = [ImageBundle imagewithBundleName:[NSString stringWithFormat:@"leve%@",_model.level]];
...
+(adminCell *)cellWithTableView:(UITableView *)tableView{
    ...
    if (!cell) {
        cell = [[XBundle currentXibBundleWithResourceName:@"adminCell"]loadNibNamed:@"adminCell" owner:self options:nil].lastObject;
    }
    return cell;
