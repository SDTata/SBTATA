...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        [selectButton setImage:[ImageBundle imagewithBundleName:@"live_danmu_nor"] forState:UIControlStateNormal];
...
-(void)toggle
{
    if(!_state)
    {
        [selectButton setImage:[ImageBundle imagewithBundleName:@"live_danmu_sel"] forState:UIControlStateNormal];
        _state = YES;
    }
    else
    {
