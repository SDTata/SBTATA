...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _imageVs.hidden = YES;
        [_imageVs  setImage:[ImageBundle imagewithBundleName:@"chat_gift_continue_normal.png"] forState:UIControlStateNormal];
        _duihao = [UIButton buttonWithType:UIButtonTypeCustom];
        _duihao.frame = CGRectMake(self.frame.size.width - 20, 4, 15,15);
        [_duihao setImage:[ImageBundle imagewithBundleName:@"chat_gift_continue_selected.png"] forState:UIControlStateNormal];
        ...
        [_kuangimage setImage:[ImageBundle imagewithBundleName:@"sel_kuang.png"]];
...
-(void)setData{
    [self.cellimageV sd_setImageWithURL:[NSURL URLWithString:_model.imagePath] placeholderImage:nil];
