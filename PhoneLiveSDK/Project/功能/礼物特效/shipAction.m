...
-(instancetype)initWithName:(NSString *)name and:(NSString *)icon{
    ...
    if (self) {
        ...
        imageV = [[UIImageView alloc]initWithImage:[ImageBundle imagewithBundleName:@"yacht_hull.png"]];
        ...
        label.text = [NSString stringWithFormat:@"%@%@",name,YZMsg(@"shipAction_shipSend")];
        ...
        imageVV.image = [ImageBundle imagewithBundleName:@"yacht_water_one.png"];
        ...
        imageVVV.image = [ImageBundle imagewithBundleName:@"yacht_water_one.png"];
...
-(void)timeII{
    ...
    [UIView animateWithDuration:10.0 animations:^{
        ...
        strongSelf->imageVVV.frame = CGRectMake(-_window_width,0,_window_width*2,_window_height*0.6);
        strongSelf->imageVV.frame = CGRectMake(0,0,_window_width*2,_window_height*0.6);
