...
//    }];
    ...
    [[NSOperationQueue mainQueue] addOperationWithBlock:^{
        ...
        strongSelf.presentView.model = strongSelf.model;
...
//        }
        ...
        strongSelf.presentView.originFrame = strongSelf.presentView.frame;
        [strongSelf.listView addSubview:strongSelf.presentView];
        
        [strongSelf.presentView animateWithCompleteBlock:^(BOOL finished,NSInteger finishCount) {
            if (strongSelf == nil) {
                return;
            }
            strongSelf.finished = finished;
            strongSelf.finishedBlock(finished,finishCount);
        }];
