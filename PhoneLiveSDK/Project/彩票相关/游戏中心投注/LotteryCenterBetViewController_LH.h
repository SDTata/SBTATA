...
@interface LotteryCenterBetViewController_LH : UIViewController<FLLayoutDatasource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (weak, nonatomic) IBOutlet UIView *bet_player_View; //龙赢
@property (weak, nonatomic) IBOutlet UIView *bet_equal_View;//和
@property (weak, nonatomic) IBOutlet UIView *bet_bank_View;//虎赢
@property (weak, nonatomic) IBOutlet UIView *bet_dragonS_View;
@property (weak, nonatomic) IBOutlet UIView *bet_dragonD_View;
@property (weak, nonatomic) IBOutlet UIView *bet_tigerS_View;
@property (weak, nonatomic) IBOutlet UIView *bet_tigerD_View;
