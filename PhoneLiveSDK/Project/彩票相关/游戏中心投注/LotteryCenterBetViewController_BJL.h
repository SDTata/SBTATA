...
@interface LotteryCenterBetViewController_BJL : UIViewController<FLLayoutDatasource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (weak, nonatomic) IBOutlet UIView *bet_player_View; //闲赢
@property (weak, nonatomic) IBOutlet UIView *bet_playerDouble_View;//闲对
@property (weak, nonatomic) IBOutlet UIView *bet_equal_View;//和
@property (weak, nonatomic) IBOutlet UIView *bet_superSix_View;//超级6点
@property (weak, nonatomic) IBOutlet UIView *bet_bank_View;//庄赢
@property (weak, nonatomic) IBOutlet UIView *bet_bankDouble_View;//庄对
