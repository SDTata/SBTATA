...
#define heightView LotteryWindowNewHeighLHC

@interface LotteryBetViewController_LHC ()<CAAnimationDelegate>{
    BOOL isShow;
...
@implementation LotteryBetViewController_LHC
...
- (void)viewDidLoad {
    ...
    self.bet_red_View = [LotteryBetView new];
    self.bet_blue_View = [LotteryBetView new];
    self.bet_green_View = [LotteryBetView new];
    self.bet_shu1_View = [LotteryBetView new];
    self.bet_shu2_View = [LotteryBetView new];
    self.bet_shu3_View = [LotteryBetView new];
    self.bet_shu4_View = [LotteryBetView new];
    self.bet_shu5_View = [LotteryBetView new];
    self.bet_shu6_View = [LotteryBetView new];
    self.bet_shu7_View = [LotteryBetView new];
    self.bet_shu8_View = [LotteryBetView new];
    self.bet_shu9_View = [LotteryBetView new];
    self.bet_shu10_View = [LotteryBetView new];
    self.bet_shu11_View = [LotteryBetView new];
    self.bet_shu12_View = [LotteryBetView new];
    ...
    [betContentView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(-self.bottomimgConstraint.constant-34);
    }];
    ...
    stackView1.transform = CGAffineTransformMakeScale(1.0, 1.1);
    ...
    stackView2.transform = CGAffineTransformMakeScale(1.0, 1.0);
    stackView2.distribution = UIStackViewDistributionFillEqually;
    [stackView2 addArrangedSubview:self.bet_red_View];
    [stackView2 addArrangedSubview:self.bet_blue_View];
    [stackView2 addArrangedSubview:self.bet_green_View];
    ...
    stackView3.transform = CGAffineTransformMakeScale(1.0, 0.9);
    stackView3.distribution = UIStackViewDistributionFillEqually;
    [stackView3 addArrangedSubview:self.bet_shu6_View];
    [stackView3 addArrangedSubview:self.bet_shu5_View];
    [stackView3 addArrangedSubview:self.bet_shu4_View];
    [stackView3 addArrangedSubview:self.bet_shu3_View];
    [stackView3 addArrangedSubview:self.bet_shu2_View];
    [stackView3 addArrangedSubview:self.bet_shu1_View];
    [betStackView addArrangedSubview:stackView3];
    ...
    stackView4.transform = CGAffineTransformMakeScale(1.0, 0.8);
    stackView4.distribution = UIStackViewDistributionFillEqually;
    [stackView4 addArrangedSubview:self.bet_shu12_View];
    [stackView4 addArrangedSubview:self.bet_shu11_View];
    [stackView4 addArrangedSubview:self.bet_shu10_View];
    [stackView4 addArrangedSubview:self.bet_shu9_View];
    [stackView4 addArrangedSubview:self.bet_shu8_View];
    [stackView4 addArrangedSubview:self.bet_shu7_View];
    [betStackView addArrangedSubview:stackView4];
    [stackView4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.height.mas_equalTo(height);
    }];
    
    betStackView.layer.transform = betTransform();
    [betStackView setCustomSpacing:6 afterView:stackView1];
    [betStackView setCustomSpacing:1 afterView:stackView2];
    [betStackView setCustomSpacing:-4 afterView:stackView3];
    
    NSArray<UIView*> *betViews = @[self.bet_big_View,self.bet_small_View,self.bet_single_View,self.bet_double_View,self.bet_shu1_View,self.bet_shu2_View,self.bet_shu3_View,self.bet_shu4_View,self.bet_shu5_View,self.bet_shu6_View,self.bet_shu7_View,self.bet_shu8_View,self.bet_shu9_View,self.bet_shu10_View,self.bet_shu11_View,self.bet_shu12_View,self.bet_red_View,self.bet_green_View,self.bet_blue_View];
...
//            strongSelf.openResutLab.hidden = NO;
        ...
        //桌子点亮及砝码动效
        [self performSelector:@selector(tableAndChipsChangedWithWinways:) withObject:winways afterDelay:3];
        ///
...
- (void)tableAndChipsChangedWithWinways:(NSArray *)winways{
    ...
    for (NSString *winName in winways) {
        ...
        if ([winName isEqualToString:@"特码A_大"]) {
        ...
        }else if ([winName isEqualToString:@"特码A_小"]){
        ...
        }else if ([winName isEqualToString:@"特码A_单"]){
        ...
        }else if ([winName isEqualToString:@"特码A_双"]){
        ...
        }else if ([winName isEqualToString:@"特肖_鼠"]){
        ...
        }else if ([winName isEqualToString:@"特肖_牛"]){
        ...
        }else if ([winName isEqualToString:@"特肖_虎"]){
        ...
        }else if ([winName isEqualToString:@"特肖_兔"]){
            betView = self.bet_shu4_View;
            imgV = [self.bet_shu4_View viewWithTag:300];
            [winViews addObject:self.bet_shu4_View];
            [winChipsTags addObject:@"20007"];
        }else if ([winName isEqualToString:@"特肖_龙"]){
            betView = self.bet_shu5_View;
            imgV = [self.bet_shu5_View viewWithTag:300];
            [winViews addObject:self.bet_shu5_View];
            [winChipsTags addObject:@"20008"];
        }else if ([winName isEqualToString:@"特肖_蛇"]){
            betView = self.bet_shu6_View;
            imgV = [self.bet_shu6_View viewWithTag:300];
            [winViews addObject:self.bet_shu6_View];
            [winChipsTags addObject:@"20009"];
        }else if ([winName isEqualToString:@"特肖_马"]){
            betView = self.bet_shu7_View;
            imgV = [self.bet_shu7_View viewWithTag:300];
            [winViews addObject:self.bet_shu7_View];
            [winChipsTags addObject:@"20010"];
        }else if ([winName isEqualToString:@"特肖_羊"]){
            betView = self.bet_shu8_View;
            imgV = [self.bet_shu8_View viewWithTag:300];
            [winViews addObject:self.bet_shu8_View];
            [winChipsTags addObject:@"20011"];
        }else if ([winName isEqualToString:@"特肖_猴"]){
            betView = self.bet_shu9_View;
            imgV = [self.bet_shu9_View viewWithTag:300];
            [winViews addObject:self.bet_shu9_View];
            [winChipsTags addObject:@"20012"];
        }else if ([winName isEqualToString:@"特肖_鸡"]){
            betView = self.bet_shu10_View;
            imgV = [self.bet_shu10_View viewWithTag:300];
            [winViews addObject:self.bet_shu10_View];
            [winChipsTags addObject:@"20013"];
        }else if ([winName isEqualToString:@"特肖_狗"]){
            betView = self.bet_shu11_View;
            imgV = [self.bet_shu11_View viewWithTag:300];
            [winViews addObject:self.bet_shu11_View];
            [winChipsTags addObject:@"20014"];
        }else if ([winName isEqualToString:@"特肖_猪"]){
            betView = self.bet_shu12_View;
            imgV = [self.bet_shu12_View viewWithTag:300];
            [winViews addObject:self.bet_shu12_View];
            [winChipsTags addObject:@"20015"];
        }else if ([winName isEqualToString:@"特码A_红波"]){
            betView = self.bet_red_View;
            imgV = [self.bet_red_View viewWithTag:300];
            [winViews addObject:self.bet_red_View];
            [winChipsTags addObject:@"20016"];
        }else if ([winName isEqualToString:@"特码A_蓝波"]){
            betView = self.bet_blue_View;
            imgV = [self.bet_blue_View viewWithTag:300];
            [winViews addObject:self.bet_blue_View];
            [winChipsTags addObject:@"20017"];
        }else if ([winName isEqualToString:@"特码A_绿波"]){
            betView = self.bet_green_View;
            imgV = [self.bet_green_View viewWithTag:300];
            [winViews addObject:self.bet_green_View];
    ...
    [UIView animateWithDuration:0.8 delay:2 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        if (strongSelf->winUsersArray.count>0) {
            ...
            for (LotteryProfit *betWinModel in strongSelf->winUsersArray) {
                ...
                if ([winWaysStr isEqualToString:@"特码A_单"]||[winWaysStr isEqualToString:@"特码A_双"]||[winWaysStr isEqualToString:@"特码A_大"]||[winWaysStr isEqualToString:@"特码A_小"]||[winWaysStr isEqualToString:@"特肖_鼠"]||[winWaysStr isEqualToString:@"特肖_牛"]||[winWaysStr isEqualToString:@"特肖_虎"]||[winWaysStr isEqualToString:@"特肖_兔"]||[winWaysStr isEqualToString:@"特肖_龙"]||[winWaysStr isEqualToString:@"特肖_蛇"]||[winWaysStr isEqualToString:@"特肖_马"]||[winWaysStr isEqualToString:@"特肖_羊"]||[winWaysStr isEqualToString:@"特肖_猴"]||[winWaysStr isEqualToString:@"特肖_鸡"] ||[winWaysStr isEqualToString:@"特肖_狗"]||[winWaysStr isEqualToString:@"特肖_猪"]||[winWaysStr isEqualToString:@"特码A_红波"]||[winWaysStr isEqualToString:@"特码A_蓝波"]||[winWaysStr isEqualToString:@"特码A_绿波"]) {
            ...
            if (dicWinWays.count>0) {
                ...
                for (int i = 0; i<winWaysStrs.count; i++) {
                    ...
                    if ([winSubWay isEqualToString:@"特码A_单"]) {
                        tagChipsub = 20000;
                    }else if([winSubWay isEqualToString:@"特码A_双"]){
                        tagChipsub = 20001;
                    }else if([winSubWay isEqualToString:@"特码A_大"]){
                        tagChipsub = 20002;
                    }else if([winSubWay isEqualToString:@"特码A_小"]){
                        tagChipsub = 20003;
                    }else if([winSubWay isEqualToString:@"特肖_鼠"]){
                        tagChipsub = 20004;
                    }else if([winSubWay isEqualToString:@"特肖_牛"]){
                        tagChipsub = 20005;
                    }else if([winSubWay isEqualToString:@"特肖_虎"]){
                        tagChipsub = 20006;
                    }else if([winSubWay isEqualToString:@"特肖_兔"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"特肖_龙"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"特肖_蛇"]){
                        tagChipsub = 20008;
                    }else if([winSubWay isEqualToString:@"特肖_马"]){
                        tagChipsub = 20009;
                    }else if([winSubWay isEqualToString:@"特肖_羊"]){
                        tagChipsub = 20010;
                    }else if([winSubWay isEqualToString:@"特肖_猴"]){
                        tagChipsub = 20011;
                    }else if([winSubWay isEqualToString:@"特肖_鸡"]){
                        tagChipsub = 20012;
                    }else if([winSubWay isEqualToString:@"特肖_狗"]){
                        tagChipsub = 20013;
                    }else if([winSubWay isEqualToString:@"特肖_猪"]){
                        tagChipsub = 20014;
                    }else if([winSubWay isEqualToString:@"特码A_红波"]){
                        tagChipsub = 20015;
                    }else if([winSubWay isEqualToString:@"特码A_蓝波"]){
                        tagChipsub = 20016;
                    }else if([winSubWay isEqualToString:@"特码A_绿波"]){
                        tagChipsub = 20017;
                    }
...
-(void)closeAndReadyToBegain
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(6 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        if (strongSelf.bet_shu4_View) [arraybgs addObject:strongSelf.bet_shu4_View];
        if (strongSelf.bet_shu5_View) [arraybgs addObject:strongSelf.bet_shu5_View];
        if (strongSelf.bet_shu6_View) [arraybgs addObject:strongSelf.bet_shu6_View];
        if (strongSelf.bet_shu7_View) [arraybgs addObject:strongSelf.bet_shu7_View];
        if (strongSelf.bet_shu8_View) [arraybgs addObject:strongSelf.bet_shu8_View];
        if (strongSelf.bet_shu9_View) [arraybgs addObject:strongSelf.bet_shu9_View];
        if (strongSelf.bet_shu10_View) [arraybgs addObject:strongSelf.bet_shu10_View];
        if (strongSelf.bet_shu11_View) [arraybgs addObject:strongSelf.bet_shu11_View];
        if (strongSelf.bet_shu12_View) [arraybgs addObject:strongSelf.bet_shu12_View];
        if (strongSelf.bet_red_View) [arraybgs addObject:strongSelf.bet_red_View];
        if (strongSelf.bet_green_View) [arraybgs addObject:strongSelf.bet_green_View];
        if (strongSelf.bet_blue_View) [arraybgs addObject:strongSelf.bet_blue_View];
...
//            }
            ...
            }else if (viewSub == strongSelf.bet_shu4_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 7) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu5_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 8) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu6_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 9) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu7_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 10) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu8_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue ==11) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu9_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 12) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu10_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 13) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu11_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 14) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else if (viewSub == strongSelf.bet_shu12_View){
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 15) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }else{
                for (NSDictionary *dc in strongSelf->_titleSts) {
                    if (((NSNumber *)dc[@"idx"]).integerValue == 16) {
                        [bubble setBetCount:dc[@"title"]];
                    }
                }
            }
...
-(void)betNotification:(NSNotification*)notification
{
    ...
    if (betModel.msg.issue == [self.curIssue longLongValue] && curLotteryType == betModel.msg.lotteryType) {
        ...
        for (int i = 0; i<arrWays.count; i++) {
            ...
            if ([subWay isEqualToString:@"特码A_大"]) {
                keyContinue = @"1";
            ...
            }else if ([subWay isEqualToString:@"特码A_小"]){
                keyContinue = @"2";
            ...
            }else if ([subWay isEqualToString:@"特码A_单"]){
                keyContinue = @"3";
            ...
            }else if ([subWay isEqualToString:@"特码A_双"]){
                keyContinue = @"4";
            ...
            }else if ([subWay isEqualToString:@"特肖_鼠"]){
                keyContinue = @"5";
            ...
            }else if ([subWay isEqualToString:@"特肖_牛"]){
                keyContinue = @"6";
            ...
            }else if ([subWay isEqualToString:@"特肖_虎"]){
                keyContinue = @"7";
            ...
            }else if ([subWay isEqualToString:@"特肖_兔"]){
                keyContinue = @"8";
                [self animationFrom:fromView toView:self.bet_shu4_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20007 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_龙"]){
                keyContinue = @"9";
                [self animationFrom:fromView toView:self.bet_shu5_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20008 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_蛇"]){
                keyContinue = @"10";
                [self animationFrom:fromView toView:self.bet_shu6_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20009 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_马"]){
                keyContinue = @"11";
                [self animationFrom:fromView toView:self.bet_shu7_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20010 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_羊"]){
                keyContinue = @"12";
                [self animationFrom:fromView toView:self.bet_shu8_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20011 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_猴"]){
                keyContinue = @"13";
                [self animationFrom:fromView toView:self.bet_shu9_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20012 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_鸡"]){
                keyContinue = @"14";
                [self animationFrom:fromView toView:self.bet_shu10_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20013 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_狗"]){
                keyContinue = @"15";
                [self animationFrom:fromView toView:self.bet_shu11_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20014 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特肖_猪"]){
                keyContinue = @"16";
                [self animationFrom:fromView toView:self.bet_shu12_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20015 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特码A_红波"]){
                keyContinue = @"17";
                [self animationFrom:fromView toView:self.bet_red_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20016 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特码A_蓝波"]){
                keyContinue = @"18";
                [self animationFrom:fromView toView:self.bet_blue_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20017 moneyNum:subMoney] uid:betModel.msg.uid];
            }else if ([subWay isEqualToString:@"特码A_绿波"]){
                keyContinue = @"19";
                [self animationFrom:fromView toView:self.bet_green_View betTotalMoney:subMoney chipView:[self getChipImgViewWithTag:20018 moneyNum:subMoney] uid:betModel.msg.uid];
            }
...
//        if (name&&[name isEqualToString:@""]) {
            for (int x = 0; x<options.count; x++) {
                ...
                if (title&&[title isEqualToString:@"特码A_大"]) {
                ...
                }else if(title&&[title isEqualToString:@"特码A_小"]){
                ...
                }else if(title&&[title isEqualToString:@"特码A_单"]){
                ...
                }else if(title&&[title isEqualToString:@"特码A_双"]){
                ...
                }else if (title&&[title isEqualToString:@"特肖_鼠"]) {
                ...
                }else if(title&&[title isEqualToString:@"特肖_牛"]){
                ...
                }else if(title&&[title isEqualToString:@"特肖_虎"]){
                ...
                }else if(title&&[title isEqualToString:@"特肖_兔"]){
                    toView = self.bet_shu4_View;
                    tagChipN = 20007;
                    UILabel *titleLabel = [self.bet_shu4_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu4_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu4_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu4_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_龙"]){
                    toView = self.bet_shu5_View;
                    tagChipN = 20008;
                    UILabel *titleLabel = [self.bet_shu5_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu5_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu5_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu5_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if (title&&[title isEqualToString:@"特肖_蛇"]) {
                    toView = self.bet_shu6_View;
                    tagChipN = 20009;
                    UILabel *titleLabel = [self.bet_shu6_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu6_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu6_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu6_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_马"]){
                    toView = self.bet_shu7_View;
                    tagChipN = 20010;
                    UILabel *titleLabel = [self.bet_shu7_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu7_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu7_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu7_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_羊"]){
                    toView = self.bet_shu8_View;
                    tagChipN = 20011;
                    UILabel *titleLabel = [self.bet_shu8_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu8_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu8_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu8_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_猴"]){
                    toView = self.bet_shu9_View;
                    tagChipN = 20012;
                    UILabel *titleLabel = [self.bet_shu9_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu9_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu9_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu9_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_鸡"]){
                    toView = self.bet_shu10_View;
                    tagChipN = 20013;
                    UILabel *titleLabel = [self.bet_shu10_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu10_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu10_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu10_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_狗"]){
                    toView = self.bet_shu11_View;
                    tagChipN = 20014;
                    UILabel *titleLabel = [self.bet_shu11_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu11_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu11_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu11_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特肖_猪"]){
                    toView = self.bet_shu12_View;
                    tagChipN = 20015;
                    UILabel *titleLabel = [self.bet_shu12_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_shu12_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_shu12_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_shu12_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特码A_红波"]){
                    toView = self.bet_red_View;
                    tagChipN = 20016;
                    UILabel *titleLabel = [self.bet_red_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_red_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_red_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_red_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特码A_蓝波"]){
                    toView = self.bet_blue_View;
                    tagChipN = 20017;
                    UILabel *titleLabel = [self.bet_blue_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_blue_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_blue_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_blue_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
                ...
                }else if(title&&[title isEqualToString:@"特码A_绿波"]){
                    toView = self.bet_green_View;
                    tagChipN = 20018;
                    UILabel *titleLabel = [self.bet_green_View viewWithTag:200];
                    UILabel *valueLabel = [self.bet_green_View viewWithTag:201];
                    UILabel *betAllLabel = [self.bet_green_View viewWithTag:101];
                    //UILabel *betMineLabel = [self.bet_bank_View viewWithTag:101];
                    BetBubbleView *bubble = [self.bet_green_View viewWithTag:1010];
                    betAllLabel.text = minnum(betall);
                    [bubble setBetCount:titleSt];
                    titleLabel.text = titleSt;
                    valueLabel.text = [@"X" stringByAppendingString:value];
...
//    });
    ...
    UINib *copennib=[UINib nibWithNibName:kLotteryOpenViewCell_LHC bundle:[XBundle currentXibBundleWithResourceName:NSStringFromClass([self class])]];
    [self.openResultList registerNib: copennib forCellWithReuseIdentifier:kLotteryOpenViewCell_LHC];
...
-(void)betWithView:(UIView *)tapView chipNum:(NSInteger)chipNum
{
    ...
    if ([tapView isEqual:self.bet_big_View]) {
        [self doBetType:@"特码A_大" chipNum:chipNum toView:self.bet_big_View];
    }else if ([tapView isEqual:self.bet_small_View]){
        [self doBetType:@"特码A_小" chipNum:chipNum toView:self.bet_small_View];
    }else if ([tapView isEqual:self.bet_single_View]){
        [self doBetType:@"特码A_单" chipNum:chipNum toView:self.bet_single_View];
    }else if ([tapView isEqual:self.bet_double_View]){
        [self doBetType:@"特码A_双"chipNum:chipNum toView:self.bet_double_View];
    }else if ([tapView isEqual:self.bet_shu1_View]){
        [self doBetType:@"特肖_鼠" chipNum:chipNum toView:self.bet_shu1_View];
    }else if ([tapView isEqual:self.bet_shu2_View]){
        [self doBetType:@"特肖_牛" chipNum:chipNum toView:self.bet_shu2_View];
    }else if ([tapView isEqual:self.bet_shu3_View]){
        [self doBetType:@"特肖_虎" chipNum:chipNum toView:self.bet_shu3_View];
    }else if ([tapView isEqual:self.bet_shu4_View]){
        [self doBetType:@"特肖_兔" chipNum:chipNum toView:self.bet_shu4_View];
    }else if ([tapView isEqual:self.bet_shu5_View]){
        [self doBetType:@"特肖_龙" chipNum:chipNum toView:self.bet_shu5_View];
    }else if ([tapView isEqual:self.bet_shu6_View]){
        [self doBetType:@"特肖_蛇" chipNum:chipNum toView:self.bet_shu6_View];
    }else if ([tapView isEqual:self.bet_shu7_View]){
        [self doBetType:@"特肖_马"chipNum:chipNum toView:self.bet_shu7_View];
    }else if ([tapView isEqual:self.bet_shu8_View]){
        [self doBetType:@"特肖_羊" chipNum:chipNum toView:self.bet_shu8_View];
    }else if ([tapView isEqual:self.bet_shu9_View]){
        [self doBetType:@"特肖_猴" chipNum:chipNum toView:self.bet_shu9_View];
    }else if ([tapView isEqual:self.bet_shu10_View]){
        [self doBetType:@"特肖_鸡" chipNum:chipNum toView:self.bet_shu10_View];
    }else if ([tapView isEqual:self.bet_shu11_View]){
        [self doBetType:@"特肖_狗" chipNum:chipNum toView:self.bet_shu11_View];
    }else if ([tapView isEqual:self.bet_shu12_View]){
        [self doBetType:@"特肖_猪" chipNum:chipNum toView:self.bet_shu12_View];
    }else if ([tapView isEqual:self.bet_red_View]){
        [self doBetType:@"特码A_红波" chipNum:chipNum toView:self.bet_red_View];
    }else if ([tapView isEqual:self.bet_blue_View]){
        [self doBetType:@"特码A_蓝波" chipNum:chipNum toView:self.bet_blue_View];
    }else if ([tapView isEqual:self.bet_green_View]){
        [self doBetType:@"特码A_绿波" chipNum:chipNum toView:self.bet_green_View];
    }
}
...
-(void)doBetType:(NSString*)detailType chipNum:(NSInteger)chipNum toView:(UIView*)toView {
    ...
    if ([detailType isEqualToString:@"特码A_大"]) {
    ...
    }else if ([detailType isEqualToString:@"特码A_小"]){
    ...
    }else if ([detailType isEqualToString:@"特码A_单"]){
    ...
    }else if ([detailType isEqualToString:@"特码A_双"]){
    ...
    }else if ([detailType isEqualToString:@"特肖_鼠"]){
    ...
    }else if ([detailType isEqualToString:@"特肖_牛"]){
    ...
    }else if ([detailType isEqualToString:@"特肖_虎"]){
    ...
    }else if ([detailType isEqualToString:@"特肖_兔"]){
        [self animationFrom:fromView toView:self.bet_shu4_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20007 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_龙"]){
        [self animationFrom:fromView toView:self.bet_shu5_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20008 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_蛇"]){
        [self animationFrom:fromView toView:self.bet_shu6_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20009 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_马"]){
        [self animationFrom:fromView toView:self.bet_shu7_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20010 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_羊"]){
        [self animationFrom:fromView toView:self.bet_shu8_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20011 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_猴"]){
        [self animationFrom:fromView toView:self.bet_shu9_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20012 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_鸡"]){
        [self animationFrom:fromView toView:self.bet_shu10_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20013 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_狗"]){
        [self animationFrom:fromView toView:self.bet_shu11_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20014 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特肖_猪"]){
        [self animationFrom:fromView toView:self.bet_shu12_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20015 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特码A_红波"]){
        [self animationFrom:fromView toView:self.bet_red_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20016 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特码A_蓝波"]){
        [self animationFrom:fromView toView:self.bet_blue_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20017 moneyNum:chipNumStr] uid:0];
    }else if ([detailType isEqualToString:@"特码A_绿波"]){
        [self animationFrom:fromView toView:self.bet_green_View betTotalMoney:chipNumStr chipView:[self getChipImgViewWithTag:20018 moneyNum:chipNumStr] uid:0];
    }
...
//            [MBProgressHUD showError:msg];
            // 清空信息
            NSArray *betViews = @[strongSelf.bet_big_View,strongSelf.bet_small_View,strongSelf.bet_single_View,strongSelf.bet_double_View,strongSelf.bet_shu1_View,strongSelf.bet_shu2_View,strongSelf.bet_shu3_View,strongSelf.bet_shu4_View,strongSelf.bet_shu5_View,strongSelf.bet_shu6_View,strongSelf.bet_shu7_View,strongSelf.bet_shu8_View,strongSelf.bet_shu9_View,strongSelf.bet_shu10_View,strongSelf.bet_shu11_View,strongSelf.bet_shu12_View,strongSelf.bet_red_View,strongSelf.bet_green_View,strongSelf.bet_blue_View];
            for (int i = 0; i<betViews.count; i++) {
...
- (void)showShaiguBoxAnimation {
    ...
    [self.animationView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(0);
        make.bottom.mas_equalTo(-VK_BOTTOM_H-60);
    }];
...
- (void)closeShaiguBoxAnimation {
    [self.contentView layoutIfNeeded];
    self.animationView.winValue = last_open_result;
    ...
    [popCodeView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(0);
        make.bottom.mas_equalTo(self.animationView.mas_top).offset(-20);
    }];
