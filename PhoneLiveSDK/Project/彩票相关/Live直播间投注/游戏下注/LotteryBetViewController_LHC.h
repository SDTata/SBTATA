...
@interface LotteryBetViewController_LHC : UIViewController<FLLayoutDatasource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (strong, nonatomic) LotteryBetView *bet_shu11_View;
@property (strong, nonatomic) LotteryBetView *bet_shu12_View;
@property (strong, nonatomic) LotteryBetView *bet_red_View;
@property (strong, nonatomic) LotteryBetView *bet_blue_View;
@property (strong, nonatomic) LotteryBetView *bet_green_View;
