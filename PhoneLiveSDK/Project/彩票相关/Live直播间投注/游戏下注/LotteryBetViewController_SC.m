...
#define heightView LotteryWindowNewHeighSC

@interface LotteryBetViewController_SC ()<CAAnimationDelegate>{
    BOOL isShow;
...
@implementation LotteryBetViewController_SC
...
- (void)viewDidLoad {
    ...
    [betContentView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(-self.bottomimgConstraint.constant-40);
    }];
    ...
    [stackView2 addArrangedSubview:self.bet_shu4_View];
    [stackView2 addArrangedSubview:self.bet_shu5_View];
    ...
    [stackView3 addArrangedSubview:self.bet_shu7_View];
    [stackView3 addArrangedSubview:self.bet_shu8_View];
    [stackView3 addArrangedSubview:self.bet_shu9_View];
    [stackView3 addArrangedSubview:self.bet_shu10_View];
    ...
    [betStackView setCustomSpacing:8 afterView:stackView2];
    
    NSArray<UIView*> *betViews = @[self.bet_big_View,self.bet_small_View,self.bet_single_View,self.bet_double_View,self.bet_shu1_View,self.bet_shu2_View,self.bet_shu3_View,self.bet_shu4_View,self.bet_shu5_View,self.bet_shu6_View,self.bet_shu7_View,self.bet_shu8_View,self.bet_shu9_View,self.bet_shu10_View];
...
//            strongSelf.openResutLab.hidden = NO;
        ...
        //桌子点亮及砝码动效
        [self performSelector:@selector(tableAndChipsChangedWithWinways:) withObject:winways afterDelay:4];
        ///
...
- (void)tableAndChipsChangedWithWinways:(NSArray *)winways{
    ...
    for (NSString *winName in winways) {
        ...
        if ([winName isEqualToString:@"冠军_大"]) {
        ...
        }else if ([winName isEqualToString:@"冠军_小"]){
        ...
        }else if ([winName isEqualToString:@"冠军_单"]){
        ...
        }else if ([winName isEqualToString:@"冠军_双"]){
        ...
        }else if ([winName isEqualToString:@"冠军_1"]){
        ...
        }else if ([winName isEqualToString:@"冠军_2"]){
        ...
        }else if ([winName isEqualToString:@"冠军_3"]){
        ...
        }else if ([winName isEqualToString:@"冠军_4"]){
        ...
        }else if ([winName isEqualToString:@"冠军_5"]){
        ...
        }else if ([winName isEqualToString:@"冠军_6"]){
        ...
        }else if ([winName isEqualToString:@"冠军_7"]){
        ...
        }else if ([winName isEqualToString:@"冠军_8"]){
        ...
        }else if ([winName isEqualToString:@"冠军_9"]){
        ...
        }else if ([winName isEqualToString:@"冠军_10"]){
    ...
    [UIView animateWithDuration:0.8 delay:2 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        if (strongSelf->winUsersArray.count>0) {
            ...
            for (LotteryProfit *betWinModel in strongSelf->winUsersArray) {
                ...
                if ([winWaysStr isEqualToString:@"冠军_单"]||[winWaysStr isEqualToString:@"冠军_双"]||[winWaysStr isEqualToString:@"冠军_大"]||[winWaysStr isEqualToString:@"冠军_小"]||[winWaysStr isEqualToString:@"冠军_1"]||[winWaysStr isEqualToString:@"冠军_2"]||[winWaysStr isEqualToString:@"冠军_3"]||[winWaysStr isEqualToString:@"冠军_4"]||[winWaysStr isEqualToString:@"冠军_5"]||[winWaysStr isEqualToString:@"冠军_6"]||[winWaysStr isEqualToString:@"冠军_7"]||[winWaysStr isEqualToString:@"冠军_8"]||[winWaysStr isEqualToString:@"冠军_9"]||[winWaysStr isEqualToString:@"冠军_10"]) {
            ...
            if (dicWinWays.count>0) {
                ...
                for (int i = 0; i<winWaysStrs.count; i++) {
                    ...
                    if ([winSubWay isEqualToString:@"冠军_单"]) {
                        tagChipsub = 20000;
                    }else if([winSubWay isEqualToString:@"冠军_双"]){
                        tagChipsub = 20001;
                    }else if([winSubWay isEqualToString:@"冠军_大"]){
                        tagChipsub = 20002;
                    }else if([winSubWay isEqualToString:@"冠军_小"]){
                        tagChipsub = 20003;
                    }else if([winSubWay isEqualToString:@"冠军_1"]){
                        tagChipsub = 20004;
                    }else if([winSubWay isEqualToString:@"冠军_2"]){
                        tagChipsub = 20005;
                    }else if([winSubWay isEqualToString:@"冠军_3"]){
                        tagChipsub = 20006;
                    }else if([winSubWay isEqualToString:@"冠军_4"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"冠军_5"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"冠军_6"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"冠军_7"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"冠军_8"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"冠军_9"]){
                        tagChipsub = 20007;
                    }else if([winSubWay isEqualToString:@"冠军_10"]){
                        tagChipsub = 20007;
                    }
...
-(void)betNotification:(NSNotification*)notification
{
    ...
    if (betModel.msg.issue == [self.curIssue longLongValue] && curLotteryType == betModel.msg.lotteryType) {
        ...
        for (int i = 0; i<arrWays.count; i++) {
            ...
            if ([subWay isEqualToString:@"冠军_大"]) {
                keyContinue = @"1";
            ...
            }else if ([subWay isEqualToString:@"冠军_小"]){
                keyContinue = @"2";
            ...
            }else if ([subWay isEqualToString:@"冠军_单"]){
                keyContinue = @"3";
            ...
            }else if ([subWay isEqualToString:@"冠军_双"]){
                keyContinue = @"4";
            ...
            }else if ([subWay isEqualToString:@"冠军_1"]){
                keyContinue = @"5";
            ...
            }else if ([subWay isEqualToString:@"冠军_2"]){
                keyContinue = @"6";
            ...
            }else if ([subWay isEqualToString:@"冠军_3"]){
                keyContinue = @"7";
            ...
            }else if ([subWay isEqualToString:@"冠军_4"]){
                keyContinue = @"8";
            ...
            }else if ([subWay isEqualToString:@"冠军_5"]){
                keyContinue = @"9";
            ...
            }else if ([subWay isEqualToString:@"冠军_6"]){
                keyContinue = @"10";
            ...
            }else if ([subWay isEqualToString:@"冠军_7"]){
                keyContinue = @"11";
            ...
            }else if ([subWay isEqualToString:@"冠军_8"]){
                keyContinue = @"12";
            ...
            }else if ([subWay isEqualToString:@"冠军_9"]){
                keyContinue = @"13";
            ...
            }else if ([subWay isEqualToString:@"冠军_10"]){
                keyContinue = @"14";
    ...
    if (uid != [[Config getOwnID] longLongValue] || uid ==0) {
        ...
        [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
            ...
            [chipImgV mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                make.bottom.equalTo(strongSelf.contentView.mas_bottom).offset(-(strongSelf.contentView.height-chipImgV.bottom));   // 设置y坐标偏移
...
//        if (name&&[name isEqualToString:@""]) {
            for (int x = 0; x<options.count; x++) {
                ...
                if (title&&[title isEqualToString:@"冠军_大"]) {
                ...
                }else if(title&&[title isEqualToString:@"冠军_小"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_单"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_双"]){
                ...
                }else if (title&&[title isEqualToString:@"冠军_1"]) {
                ...
                }else if(title&&[title isEqualToString:@"冠军_2"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_3"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_4"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_5"]){
                ...
                }else if (title&&[title isEqualToString:@"冠军_6"]) {
                ...
                }else if(title&&[title isEqualToString:@"冠军_7"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_8"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_9"]){
                ...
                }else if(title&&[title isEqualToString:@"冠军_10"]){
...
//    });
    ...
    UINib *copennib=[UINib nibWithNibName:kLotteryOpenViewCell_SC bundle:[XBundle currentXibBundleWithResourceName:NSStringFromClass([self class])]];
    [self.openResultList registerNib: copennib forCellWithReuseIdentifier:kLotteryOpenViewCell_SC];
...
-(void)betWithView:(UIView *)tapView chipNum:(NSInteger)chipNum
{
    ...
    if ([tapView isEqual:self.bet_big_View]) {
        [self doBetType:@"冠军_大" chipNum:chipNum toView:self.bet_big_View];
    }else if ([tapView isEqual:self.bet_small_View]){
        [self doBetType:@"冠军_小" chipNum:chipNum toView:self.bet_small_View];
    }else if ([tapView isEqual:self.bet_single_View]){
        [self doBetType:@"冠军_单" chipNum:chipNum toView:self.bet_single_View];
    }else if ([tapView isEqual:self.bet_double_View]){
        [self doBetType:@"冠军_双"chipNum:chipNum toView:self.bet_double_View];
    }else if ([tapView isEqual:self.bet_shu1_View]){
        [self doBetType:@"冠军_1" chipNum:chipNum toView:self.bet_shu1_View];
    }else if ([tapView isEqual:self.bet_shu2_View]){
        [self doBetType:@"冠军_2" chipNum:chipNum toView:self.bet_shu2_View];
    }else if ([tapView isEqual:self.bet_shu3_View]){
        [self doBetType:@"冠军_3" chipNum:chipNum toView:self.bet_shu3_View];
    }else if ([tapView isEqual:self.bet_shu4_View]){
        [self doBetType:@"冠军_4" chipNum:chipNum toView:self.bet_shu4_View];
    }else if ([tapView isEqual:self.bet_shu5_View]){
        [self doBetType:@"冠军_5" chipNum:chipNum toView:self.bet_shu5_View];
    }else if ([tapView isEqual:self.bet_shu6_View]){
        [self doBetType:@"冠军_6" chipNum:chipNum toView:self.bet_shu6_View];
    }else if ([tapView isEqual:self.bet_shu7_View]){
        [self doBetType:@"冠军_7"chipNum:chipNum toView:self.bet_shu7_View];
    }else if ([tapView isEqual:self.bet_shu8_View]){
        [self doBetType:@"冠军_8" chipNum:chipNum toView:self.bet_shu8_View];
    }else if ([tapView isEqual:self.bet_shu9_View]){
        [self doBetType:@"冠军_9" chipNum:chipNum toView:self.bet_shu9_View];
    }else if ([tapView isEqual:self.bet_shu10_View]){
        [self doBetType:@"冠军_10" chipNum:chipNum toView:self.bet_shu10_View];
    }
}
...
-(void)doBetType:(NSString*)detailType chipNum:(NSInteger)chipNum toView:(UIView*)toView {
    ...
    if ([detailType isEqualToString:@"冠军_大"]) {
    ...
    }else if ([detailType isEqualToString:@"冠军_小"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_单"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_双"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_1"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_2"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_3"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_4"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_5"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_6"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_7"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_8"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_9"]){
    ...
    }else if ([detailType isEqualToString:@"冠军_10"]){
...
- (void)showShaiguBoxAnimation {
    ...
    [self.animationView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.mas_equalTo(0);
        make.bottom.mas_equalTo(-VK_BOTTOM_H-80);
    }];
...
-(void)refreshOpenListView{
    ...
    NSInteger result_count = open_result.count;
    if(result_count){
        NSString * oneStr = open_result[0];
        self.shuLab.text = open_result[0];
        if([oneStr intValue] < 6){
            self.smallLab.text = YZMsg(@"lobby_small");
        }else{
            self.smallLab.text = YZMsg(@"lobby_big");
        }
        if([oneStr intValue]%2 == 0){
            self.openResutLab.text = YZMsg(@"lobby_double");
        }else{
            self.openResutLab.text = YZMsg(@"lobby_single");
        }
    }
}
