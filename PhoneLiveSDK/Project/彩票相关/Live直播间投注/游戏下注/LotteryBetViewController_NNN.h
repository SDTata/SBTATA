...
@interface LotteryBetViewController_NNN : UIViewController<FLLayoutDatasource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (strong, nonatomic) LotteryBetView *bet_player_View; //蓝方胜
@property (strong, nonatomic) LotteryBetView *bet_playerDouble_View;//红方胜
@property (strong, nonatomic) LotteryBetView *bet_equal_View;//蓝方无牛
@property (strong, nonatomic) LotteryBetView *bet_superSix_View;//蓝方牛牛
@property (strong, nonatomic) LotteryBetView *bet_bank_View;//红方无牛
@property (strong, nonatomic) LotteryBetView *bet_bankDouble_View;//红方牛牛
@property (strong, nonatomic) LotteryResultView_NN *result_blue_View;
@property (strong, nonatomic) LotteryResultView_NN *result_red_View;
