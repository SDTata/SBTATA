...
@interface LotteryBetViewController_ZP : UIViewController<FLLayoutDatasource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (strong, nonatomic) LotteryBetView *bet_small_View;
@property (strong, nonatomic) LotteryBetView *bet_single_View;
@property (strong, nonatomic) LotteryBetView *bet_double_View;
@property (strong, nonatomic) LotteryBetView *bet_bao1_View;
@property (strong, nonatomic) LotteryBetView *bet_bao6_View;
@property (strong, nonatomic) LotteryBetView *bet_red_View;
@property (strong, nonatomic) LotteryBetView *bet_black_View;
