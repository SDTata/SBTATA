...
@end
@implementation OpenNNHistoryCell

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self = [[XBundle currentXibBundleWithResourceName:@"OpenNNHistoryCell"]loadNibNamed:@"OpenNNHistoryCell" owner:self options:nil].lastObject;
    }
    return self;
}
